class PipelineDiagnostics {
  ...
  int get executionTimeMs => endTime > 0 ? endTime - startTime : DateTime.now().millisecondsSinceEpoch - startTime;
  ...
  int get activeAllocations => (memoryStates['allocated'] ?? 0) - (memoryStates['disposed'] ?? 0);
